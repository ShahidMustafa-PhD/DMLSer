...
class LayerRegion
{
	...
	//  every layer has support as well
...
class Layer {
    ...
    //-layers are devided between buildstyles...
    ...
    bool isAnchor_Layer=false;  //  set true for anchor layers.. otherwise false..                          ///< also known as 'islands' (all regions and surface types are merged here)
    ...
    void process_external_surfaces();
    void detect_support_surface();
	void write_svg(SVG *sv);
	void write_svg_layers();
    void detect_support_layers();
    protected:
...
#define FOREACH_Surfaces(surfaces, surface) FOREACH_BASE(Surfaces, surfaces, surface)
