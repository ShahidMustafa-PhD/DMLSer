...
ModelObject::arrange_volumes()
{
    ...
    if (! this->_arrange(volume_sizes,5, bb, positions))
        return false;
...
void
ModelVolume::Move_to_Position_on_bed(const Pointf &point)
{
 
	this->mesh.translate(-point.x, -point.y, 0);
