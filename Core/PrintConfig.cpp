...
{   //   std::vector<std::string>   enum_values;
   ...
   //typedef std::map<std::string,int> t_config_enum_values;
    ...
    external_fill_pattern.enum_values.push_back("rectilinear");//  there is a vector of strings..
	...
	external_fill_pattern.enum_labels.push_back("slmisland");
    external_fill_pattern.enum_labels.push_back("slmstrips");
	external_fill_pattern.enum_labels.push_back("slmchessboard");
    ConfigOptionDef* def;
    ...
    def->enum_values.push_back("0");
    def->enum_labels.push_back("auto");
    def->default_value = new ConfigOptionFloatOrPercent(0.1, true);
	...
	def->enum_labels.push_back("SLM Islands");
	def->enum_labels.push_back("SLM Strips");
	def->enum_labels.push_back("SLM ChessBoard");
    def->default_value = new ConfigOptionEnum<InfillPattern>(ipSLMisland);
	...
	def->enum_labels.push_back("SLM");
    def->default_value = new ConfigOptionEnum<GCodeFlavor>(gcfSLM);
    ...
    def->min = 0;
    def->max = 359;
    def->default_value = new ConfigOptionInt(45);
    ...
    def->min = 1;
    {
        ...
        def->default_value = new ConfigOptionInt(threads > 0 ? threads : 3);
    }
	...
	def = this->add("Hatch_Spacing", coFloat);
    def->label = "Distance Between lines";
    def->category = "Advanced";
    def->tooltip = "Hatch Spacing between Fill Lines:";
    def->sidetext = "mm";
    def->cli = "hatch_spacing=f";
    def->default_value = new ConfigOptionFloat(0.1);
	
	def = this->add("island_H", coFloat);
    def->label = "Height of island Square  of SLM Fill";
    def->category = "Advanced";
    def->tooltip = "Height of island Square:";
    def->sidetext = "mm";
    def->cli = "islandH=f";
    def->default_value = new ConfigOptionFloat(3);
	
	def = this->add("island_L", coFloat);
    def->label = "Length of island Square  of SLM Fill";
    def->category = "Advanced";
    def->tooltip = "Length of island Square:";
    def->sidetext = "mm";
    def->cli = "islandL=f";
    def->default_value = new ConfigOptionFloat(3);
	
	def = this->add("SLM_Strip", coBool);
    def->label = "Makes Strip Scan Patterns";
    def->tooltip = "Strip Scan Pattern for SLM";
    def->cli = "slmstrip!";
    def->default_value = new ConfigOptionBool(false);
	
	def = this->add("SLM_ChessBoard", coBool);
    def->label = "Makes Chess Board Patterns";
    def->tooltip = "Chess Board Pattern for SLM";
    def->cli = "slmchessboard";
    def->default_value = new ConfigOptionBool(false);
	
	def = this->add("SLM_overlap", coFloat);
    def->label = "Overlap betwwen lines";
    def->tooltip = "Overlap to ensure  full melting.";
    def->cli = "overlap";
    def->min = -1.5;
	def->max = 1.5;
    def->default_value = new ConfigOptionFloat(0.001);
	
    def = this->add("support_laser_speed", coFloat);
    def->label = "laser parameter of suuport";
    def->tooltip = "support_laser_speed.";
    def->cli = "support-speed";
    def->min = 1;
    def->default_value = new ConfigOptionFloat(20);
	
	def = this->add("core_scan_speed", coFloat);
    def->label = "laser parameter of Layer region";
    def->tooltip = "SLM_Layer_laser_speed.";
    def->cli = "layer-speed";
    def->min = 1;
    def->default_value = new ConfigOptionFloat(20);
	
	def = this->add("core_laser_power", coInt);
    def->label = "laser power parameter of Layer region";
    def->tooltip = "SLM_Layer_laser_power.";
    def->cli = "layer-power";
    def->min = 1;
    def->default_value = new ConfigOptionInt(40);
	

     
	def = this->add("Laser_ONN_Delay", coInt);
    def->label = "Laser ONN Delay in usec";
    def->category = "Advanced";
    def->tooltip ="Laser ONN Delay";
    //def->cli = "sequential-print-priority=i";
	def->min = 50;
    def->default_value = new ConfigOptionInt(200);
	
	def = this->add("Laser_OFF_Delay", coInt);
    def->label = "Laser OFF Delay in usec";
    def->category = "Advanced";
    def->tooltip ="Laser OFF Delay";
    //def->cli = "sequential-print-priority=i";
	def->min = 50;
    def->default_value = new ConfigOptionInt(200);
	
	def = this->add("Jump_Delay", coInt);
    def->label = "Jump Delay in usec";
    def->category = "Advanced";
    def->tooltip ="Laser Jump Delay";
    //def->cli = "sequential-print-priority=i";
	def->min = 50;
    def->default_value = new ConfigOptionInt(200);
	
	def = this->add("Mark_Delay", coInt);
    def->label = " Mark Delay in usec";
    def->category = "Advanced";
    def->tooltip ="Laser Mark Delay";
    //def->cli = "sequential-print-priority=i";
	def->min = 50;
    def->default_value = new ConfigOptionInt(200);
	
	def = this->add("Poly_Delay", coInt);
    def->label = " Poly Delay in usec";
    def->category = "Advanced";
    def->tooltip ="Laser Poly Delay";
    //def->cli = "sequential-print-priority=i";
	def->min = 50;
    def->default_value = new ConfigOptionInt(200);
	
	def = this->add("Set_Mode", coInt);
    def->label = "Laser Mode  int";
    def->category = "Advanced";
    def->tooltip ="Laser Mode";

    def->default_value = new ConfigOptionInt(1050);
	
	
	def = this->add("Bridge_Mark_speed", coFloat);
    def->label = "Laser speed for brige  ";
    def->category = "Advanced";
    def->tooltip ="Laser Mode";
    def->default_value = new ConfigOptionFloat(100);
	
	def = this->add("Part_XY_Position", coPoint);
    def->label = "Position of the Part On built plate";
    def->tooltip = "";
    def->sidetext = "mm";
    def->cli = "part_position=s@";
     def->default_value = new  ConfigOptionPoint(Pointf(0,0));
	
    
	// support structure
def = this->add("Alternative_layers", coInt);
    def->label = "Number of layers to be skipped_layers";
    def->category = "Advanced";
    def->tooltip ="The spport structure can be processed after skiping a layer or two.";
    //def->cli = "sequential-print-priority=i";
    def->default_value = new ConfigOptionInt(1);
def = this->add("tooth_hieght", coFloat);
    def->label = "support structure tooth hieght  ";
    def->category = "Advanced";
    def->tooltip ="support structure";
    def->default_value = new ConfigOptionFloat(2);

	
def = this->add("tooth_top_length", coFloat);
    def->label = "support structure tooth top length  ";
    def->category = "Advanced";
    def->tooltip ="support structure";
    def->default_value = new ConfigOptionFloat(0.8);
		
def = this->add("tooth_base_length", coFloat);
    def->label = "support structure tooth base length  ";
    def->category = "Advanced";
    def->tooltip ="support structure";
    def->default_value = new ConfigOptionFloat(1.5);

def = this->add("tooth_no_support_offset", coFloat);
    def->label = "support structure offset from walls  ";
    def->category = "Advanced";
    def->tooltip ="support structure";
    
def->default_value = new ConfigOptionFloat(1.5);
	def = this->add("support_laser_power", coInt);
    def->label = "laser power parameter of support region";
    def->tooltip = "SLM_support_laser_power.";
    def->min = 1;
    def->default_value = new ConfigOptionInt(40);


def = this->add("skin_scan_speed", coFloat);
    def->label = "Laser speed for skin  ";
    def->category = "Advanced";
    def->tooltip ="Laser speed";
    def->default_value = new ConfigOptionFloat(100);
	
def = this->add("skin_laser_power", coInt);
    def->label = "laser power parameter of support region";
    def->tooltip = "SLM_support_laser_power.";
    def->min = 1;
    def->default_value = new ConfigOptionInt(40);
	
def = this->add("downskin_scan_speed", coFloat);
    def->label = "Laser speed for overhang  ";
    def->category = "Advanced";
    def->tooltip ="overhangs Laser speed";
    def->default_value = new ConfigOptionFloat(100);
	
def = this->add("downskin_laser_power", coInt);
    def->label = "laser power parameter for downskin";
    def->tooltip = "SLM_support_laser_power.";

    def->min = 1;
    def->default_value = new ConfigOptionInt(40);
	
	def = this->add("upskin_scan_speed", coFloat);
    def->label = "Laser speed for tops  ";
    def->category = "Advanced";
    def->tooltip ="overhangs Laser speed";
    def->default_value = new ConfigOptionFloat(100);
	
def = this->add("upskin_laser_power", coInt);
    def->label = "laser power parameter for tops";
    def->tooltip = "SLM_support_laser_power.";

    def->min = 1;
    def->default_value = new ConfigOptionInt(40);
  
  def = this->add("Anchor_hieght", coFloat);
    def->label = "Base Anchors  hieght in mm ";
    def->category = "Advanced";
    def->tooltip ="Anchors";
    def->default_value = new ConfigOptionFloat(6); // 6 mm default.
	
	def = this->add("Anchor_layer_thickness", coFloat);
    def->label = "Base Anchors  layer thickness  in mm ";
    def->category = "Advanced";
    def->tooltip ="Anchors";
    def->default_value = new ConfigOptionFloat(0.2); // 200 um default.
...
CLIConfigDef::CLIConfigDef()
{
    ...
    def->label = "Export GCODE";
    def->tooltip = "Slice the model and generate GCODE.";
    def->cli = "export_gcode";
    def->default_value = new ConfigOptionBool(false);
