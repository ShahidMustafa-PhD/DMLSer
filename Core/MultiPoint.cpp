...
Points
MultiPoint::_douglas_peucker(const Points &points, const double tolerance) // tolerance
{  // double  tolerance= 0.5;//  asserted by DMLS... Make this tolerence small..
  //  otherwise   polygon will loose the points too close..
