...
Extruder::Extruder(unsigned int id, GCodeConfig *configg)
:   id(id),
    configg(configg)
{
    reset();
...
Extruder::extrude(double dE)
{
    ...
    if (this->configg->use_relative_e_distances)
        this->E = 0;
...
{
    if (this->configg->use_volumetric_e) {
...
{
    return this->configg->filament_diameter.get_at(this->id);
}

double
Extruder::filament_density() const
{
    return this->configg->filament_density.get_at(this->id);
}

double
Extruder::filament_cost() const
{
    return this->configg->filament_cost.get_at(this->id);
}

double
Extruder::extrusion_multiplier() const
{
    return this->configg->extrusion_multiplier.get_at(this->id);
}

double
Extruder::retract_length() const
{
    return this->configg->retract_length.get_at(this->id);
}

double
Extruder::retract_lift() const
{
    return this->configg->retract_lift.get_at(this->id);
}

int
Extruder::retract_speed() const
{
    return this->configg->retract_speed.get_at(this->id);
}

double
Extruder::retract_restart_extra() const
{
    return this->configg->retract_restart_extra.get_at(this->id);
}

double
Extruder::retract_length_toolchange() const
{
    return this->configg->retract_length_toolchange.get_at(this->id);
}

double
Extruder::retract_restart_extra_toolchange() const
{
    return this->configg->retract_restart_extra_toolchange.get_at(this->id);
}
