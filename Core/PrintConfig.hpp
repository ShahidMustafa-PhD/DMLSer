...
enum InfillPattern {
    ...
    ipHilbertCurve, ipArchimedeanChords, ipOctagramSpiral,ipSLMisland,
	ipSLMstrips,ipSLMchessboard,
};
...
template<> inline t_config_enum_values ConfigOptionEnum<GCodeFlavor>::get_enum_values() {
    t_config_enum_values keys_map; // map<string, int>
...
template<> inline t_config_enum_values ConfigOptionEnum<InfillPattern>::get_enum_values() {
	...
	keys_map["slmisland"]           = ipSLMisland;
	keys_map["slmstrips"]           = ipSLMstrips;
	keys_map["slmchessboard"]       = ipSLMchessboard;
    return keys_map;
}
...
class PrintObjectConfig : public virtual StaticPrintConfig
{
    ...
    ConfigOptionFloat               Anchor_hieght;
	ConfigOptionFloat               Anchor_layer_thickness;
    ...
    virtual ConfigOption* optptr(const t_config_option_key &opt_key, bool create = false) {
		...
		OPT_PTR(Anchor_layer_thickness);
		OPT_PTR(Anchor_hieght);
...
class PrintRegionConfig : public virtual StaticPrintConfig
{
    ...
    ConfigOptionFloat               Hatch_Spacing;
	ConfigOptionBool                SLM_ChessBoard;
    ConfigOptionFloat               island_L;
	ConfigOptionFloat               island_H;
	ConfigOptionFloat               tooth_hieght;
	ConfigOptionFloat               tooth_top_length;
	ConfigOptionFloat               tooth_base_length;
	ConfigOptionFloat               tooth_no_support_offset;
    ConfigOptionInt                 support_laser_power;
	ConfigOptionFloats              skin_scan_speed;
	ConfigOptionInt                 skin_laser_power;
	ConfigOptionFloats              downskin_scan_speed;
	ConfigOptionInt                 downskin_laser_power;
	ConfigOptionFloats              upskin_scan_speed;
	ConfigOptionInt                 upskin_laser_power;
	ConfigOptionFloat               support_material_spacing;
	ConfigOptionInt                 support_material_angle;


	//ConfigOptionFloat               SLM_overlap;
    ...
    virtual ConfigOption* optptr(const t_config_option_key &opt_key, bool create = false) {
        ...
        OPT_PTR(Hatch_Spacing);
		OPT_PTR(SLM_ChessBoard);
		OPT_PTR(island_L);
		OPT_PTR(island_H);
		OPT_PTR(tooth_hieght);
		OPT_PTR(tooth_top_length);
		OPT_PTR(tooth_base_length);
        OPT_PTR(tooth_no_support_offset);
        OPT_PTR(support_laser_power);
        OPT_PTR(skin_laser_power);
        OPT_PTR(skin_scan_speed);
        OPT_PTR(downskin_laser_power);
        OPT_PTR(downskin_scan_speed);
        OPT_PTR(upskin_laser_power);
        OPT_PTR(upskin_scan_speed);		
    ...
    : public virtual StaticPrintConfig
{
    ...
    ConfigOptionBool                SLM_ChessBoard;
	ConfigOptionFloat               SLM_overlap;
	ConfigOptionFloat               support_laser_speed;
	ConfigOptionFloat               core_scan_speed;
	ConfigOptionInt                 core_laser_power;
	ConfigOptionInt                 Alternative_layers;
	ConfigOptionInt                 Laser_ONN_Delay;
	ConfigOptionInt                 Laser_OFF_Delay;
	ConfigOptionInt                 Jump_Delay;
	ConfigOptionInt                 Mark_Delay;
	ConfigOptionInt                 Poly_Delay;
	ConfigOptionInt                 Set_Mode;
	ConfigOptionFloat               Bridge_Mark_speed;
	ConfigOptionPoints              Part_XY_Position;
	ConfigOptionFloat               tooth_hieght;
	ConfigOptionFloat               tooth_top_length;
	ConfigOptionFloat               tooth_base_length;
	ConfigOptionFloat               tooth_no_support_offset;
    ...
    virtual ConfigOption* optptr(const t_config_option_key &opt_key, bool create = false) {
        ...
        OPT_PTR(SLM_ChessBoard);
	    OPT_PTR(SLM_overlap);
        OPT_PTR(support_laser_speed);
        OPT_PTR(core_scan_speed);	
        OPT_PTR(core_laser_power);		
        OPT_PTR(Alternative_layers);
        OPT_PTR(Laser_ONN_Delay);
        OPT_PTR(Laser_OFF_Delay);
        OPT_PTR(Jump_Delay);
        OPT_PTR(Mark_Delay);
        OPT_PTR(Poly_Delay);		
        OPT_PTR(Set_Mode);
        OPT_PTR(Bridge_Mark_speed);
        OPT_PTR(Part_XY_Position);
		OPT_PTR(tooth_hieght);
		OPT_PTR(tooth_top_length);
		OPT_PTR(tooth_base_length);
        OPT_PTR(tooth_no_support_offset);
